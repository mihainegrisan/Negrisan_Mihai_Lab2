...
namespace Negrisan_Mihai_Lab2.Migrations
{
    ...
    [Migration("20211021165304_ExtendedModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Negrisan_Mihai_Lab2.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("Negrisan_Mihai_Lab2.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("Negrisan_Mihai_Lab2.Models.PublishedBook", b =>
                {
                    b.Property<int>("BookID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Negrisan_Mihai_Lab2.Models.Order", b =>
                {
                    b.HasOne("Negrisan_Mihai_Lab2.Models.Book", "Book")
                        .WithMany("Orders")
                        .HasForeignKey("BookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Negrisan_Mihai_Lab2.Models.Customer", "Customer")
                        .WithMany("Orders")
